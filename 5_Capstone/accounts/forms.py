...
class SignUpForm(UserCreationForm):
    ...
    email = forms.EmailField(max_length=40, required=True, help_text='*Required')
    username = forms.CharField(max_length=30, required=True, help_text='*Required')
    location = forms.CharField(max_length=50, required=False, help_text='Optional')
    birthdate = forms.DateField(widget=forms.SelectDateWidget(years=range(1900, 2100)), required=False, help_text='Optional')
